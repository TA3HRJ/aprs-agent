...
class AgentManager:
    ...
    # of 1,110 silence episode openings (32.3%) in the live database had
    # opened inside that window and carry no note because of it. The saving
    # it bought was cents a month against a $0.36 total.
